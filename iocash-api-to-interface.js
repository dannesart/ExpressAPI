...
let url =
  "https://api.io.cash/portal/apis/5eb271185519ef00014fea56/documentation/raw";
let fileName = "IOCashAPI";
let libName = "";
let outputDirPath = "./payment";
let options = {
  method: "GET",
};
let allTags = {};
    ...
    */`);
    ...
    Object.keys(paths).forEach((endpoint) => {
      ...
      Object.keys(methods).forEach((methodType) => {
        ...
        const { tags, parameters, operationId, summary, deprecated } = methods[
          methodType
        ];
